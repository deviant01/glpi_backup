...
$LANG['plugin_backups']['title'][2] = "Tapes";
$LANG['plugin_backups']['title'][4] = "Synthesis";
$LANG['plugin_backups']['title'][5] = "Tapes pool";
$LANG['plugin_backups']['title'][6] = "Log files";
$LANG['plugin_backups']['title'][7] = "XML Files";
$LANG['plugin_backups']['title'][8] = "Scripts";
$LANG['plugin_backups']['title'][9] = "Backups historicals";
$LANG['plugin_backups']['title'][10] = "Job";
$LANG['plugin_backups']['title'][11] = "Tape";
$LANG['plugin_backups']['title'][12] = "Tape pool";
$LANG['plugin_backups']['title'][13] = "Backups historical";
$LANG['plugin_backups']['title'][14] = "Script";

$LANG['plugin_backups']['buttons'][5] = "Associate a tapes pool";
$LANG['plugin_backups']['buttons'][8] = "Dissociate a tapes pool";
$LANG['plugin_backups']['buttons'][9] = "Associate a job";
$LANG['plugin_backups']['buttons'][10] = "Dissociate a job";
$LANG['plugin_backups']['buttons'][11] = "Associate a tape";
$LANG['plugin_backups']['buttons'][12] = "Dissociate a tape";
$LANG['plugin_backups']['buttons'][13] = "Associate a software";
$LANG['plugin_backups']['buttons'][14] = "Dissociate a software";
$LANG['plugin_backups']['buttons'][15] = "Associate a peripheral";
$LANG['plugin_backups']['buttons'][16] = "Dissociate a peripheral";
$LANG['plugin_backups']['buttons'][17] = "Associate a safeguarded element";
$LANG['plugin_backups']['buttons'][18] = "Dissociate a safeguarded element";
$LANG['plugin_backups']['buttons'][19] = "Associate a script";
$LANG['plugin_backups']['buttons'][20] = "Dissociate a script";
$LANG['plugin_backups']['buttons'][21] = "Associate a NAS";
$LANG['plugin_backups']['buttons'][22] = "Dissociate a NAS";

$LANG['plugin_backups']['profile'][0] = "Rights management";

//works
$LANG['plugin_backups']['works'][5] = "Selection list";
$LANG['plugin_backups']['works'][9] = "Periodicity";
$LANG['plugin_backups']['works'][10] = "Associated tape(s) pool(s)";
$LANG['plugin_backups']['works'][12] = "Complete";
$LANG['plugin_backups']['works'][13] = "Differential";
$LANG['plugin_backups']['works'][14] = "Incremental";
$LANG['plugin_backups']['works'][17] = "Associated Peripherical(s)";
$LANG['plugin_backups']['works'][18] = "Associated safeguarded elements";
$LANG['plugin_backups']['works'][19] = "Supports";
$LANG['plugin_backups']['works'][22] = "Associated script(s)";
$LANG['plugin_backups']['works'][24] = "Backups Historical";
$LANG['plugin_backups']['works'][25] = "Associated historical(s)";
$LANG['plugin_backups']['works'][28] = "Backups historical(s)";
$LANG['plugin_backups']['works'][30] = "Associated Job(s)";
$LANG['plugin_backups']['works'][31] = "Associated Job(s) with tihs NAS";

//history
$LANG['plugin_backups']['history'][6] = "Job";
$LANG['plugin_backups']['history'][10] = "Finished";
$LANG['plugin_backups']['history'][11] = "Failed";

//libraries
$LANG['plugin_backups']['libraries'][3] = "Associated tapes pool";
$LANG['plugin_backups']['libraries'][13] = "Associated tapes(s)";

//tapes
$LANG['plugin_backups']['tapes'][2] = "Associated tape(s)";
$LANG['plugin_backups']['tapes'][3] = "Associated job(s)"; 
$LANG['plugin_backups']['tapes'][7] = "Capacity";
$LANG['plugin_backups']['tapes'][9] = "Cut-over date";
$LANG['plugin_backups']['tapes'][10] = "Place of storage";
$LANG['plugin_backups']['tapes'][12] = "Mark";

//scripts
$LANG['plugin_backups']['scripts'][3] = "Server Site";

//setup
$LANG['plugin_backups']['setup'][4] = "Type of script";
$LANG['plugin_backups']['setup'][5] = "Type of periodicity";
$LANG['plugin_backups']['setup'][6] = "Type of tape";
$LANG['plugin_backups']['setup'][7] = "Status of hitory";
$LANG['plugin_backups']['setup'][9] = "Type of backup";

$LANG['plugin_backups']['parser'][0] = "Files";
$LANG['plugin_backups']['parser'][1] = "See the log";
$LANG['plugin_backups']['parser'][2] = "Cannot find the XML file";
$LANG['plugin_backups']['parser'][3] = "No file found in the folder";
