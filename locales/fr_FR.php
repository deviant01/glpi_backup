...
//Français
$LANG['plugin_backups']['title'][0] = "Sauvegardes";
$LANG['plugin_backups']['title'][1] = "Travaux";
$LANG['plugin_backups']['title'][2] = "Bandes";
$LANG['plugin_backups']['title'][4] = "Synthèse Sauvegardes";
$LANG['plugin_backups']['title'][5] = "Jeux de support";
$LANG['plugin_backups']['title'][6] = "Fichiers Log";
$LANG['plugin_backups']['title'][7] = "Fichiers XML";
$LANG['plugin_backups']['title'][8] = "Scripts";
$LANG['plugin_backups']['title'][9] = "Historiques de sauvegarde";
$LANG['plugin_backups']['title'][10] = "Travail";
$LANG['plugin_backups']['title'][11] = "Bande";
$LANG['plugin_backups']['title'][12] = "Jeu de support";
$LANG['plugin_backups']['title'][13] = "Historique de sauvegarde";
$LANG['plugin_backups']['title'][14] = "Script";

$LANG['plugin_backups']['buttons'][5] = "Associer un jeux de support";
$LANG['plugin_backups']['buttons'][8] = "Dissocier un jeux de support";
$LANG['plugin_backups']['buttons'][9] = "Associer un travail";
$LANG['plugin_backups']['buttons'][10] = "Dissocier un travail";
$LANG['plugin_backups']['buttons'][11] = "Associer une bande";
$LANG['plugin_backups']['buttons'][12] = "Dissocier une bande";
$LANG['plugin_backups']['buttons'][13] = "Associer un logiciel";
$LANG['plugin_backups']['buttons'][14] = "Dissocier un logiciel";
$LANG['plugin_backups']['buttons'][15] = "Associer un périphérique";
$LANG['plugin_backups']['buttons'][16] = "Dissocier un périphérique";
$LANG['plugin_backups']['buttons'][17] = "Associer un élément sauvegardé";
$LANG['plugin_backups']['buttons'][18] = "Dissocier un élément sauvegardé";
$LANG['plugin_backups']['buttons'][19] = "Associer un script";
$LANG['plugin_backups']['buttons'][20] = "Dissocier un script";
$LANG['plugin_backups']['buttons'][21] = "Associer un NAS";
$LANG['plugin_backups']['buttons'][22] = "Dissocier un NAS";

$LANG['plugin_backups']['profile'][0] = "Gestion des droits";

//works
$LANG['plugin_backups']['works'][5] = "Liste de sélection";
$LANG['plugin_backups']['works'][9] = "Periodicité";
$LANG['plugin_backups']['works'][10] = "Jeu(x) de support(s) associé(s)";
$LANG['plugin_backups']['works'][12] = "Complète";
$LANG['plugin_backups']['works'][13] = "Différentielle";
$LANG['plugin_backups']['works'][14] = "Incrémentielle";
$LANG['plugin_backups']['works'][17] = "Elément(s) associé(s)";
$LANG['plugin_backups']['works'][18] = "Elément(s) sauvegardé(s) associé(s)";
$LANG['plugin_backups']['works'][19] = "Supports";
$LANG['plugin_backups']['works'][22] = "Script(s) associé(s)";
$LANG['plugin_backups']['works'][24] = "Historiques de sauvegarde";
$LANG['plugin_backups']['works'][25] = "Historique(s) associé(s)";
$LANG['plugin_backups']['works'][28] = "Historique(s) de sauvegarde(s)";
$LANG['plugin_backups']['works'][30] = "Travaux de sauvegarde associés";
$LANG['plugin_backups']['works'][31] = "Travaux de sauvegarde associés à ce NAS";

//history
$LANG['plugin_backups']['history'][6] = "Travail";
$LANG['plugin_backups']['history'][10] = "Terminée";
$LANG['plugin_backups']['history'][11] = "Echouée";

//libraries
$LANG['plugin_backups']['libraries'][3] = "Jeu(x) de support associé(s)";
$LANG['plugin_backups']['libraries'][13] = "Bande(s) associée(s)"; 

//tapes
$LANG['plugin_backups']['tapes'][2] = "Bande(s) associée(s)";
$LANG['plugin_backups']['tapes'][3] = "Travaux associés";
$LANG['plugin_backups']['tapes'][7] = "Capacité";
$LANG['plugin_backups']['tapes'][9] = "Date de mise en service";
$LANG['plugin_backups']['tapes'][10] = "Lieu de stockage";
$LANG['plugin_backups']['tapes'][12] = "Marque";

//scripts
$LANG['plugin_backups']['scripts'][3] = "Emplacement serveur";

//setup
$LANG['plugin_backups']['setup'][4] = "Type de script";
$LANG['plugin_backups']['setup'][5] = "Type de périodicité";
$LANG['plugin_backups']['setup'][6] = "Type de bande";
$LANG['plugin_backups']['setup'][7] = "Statut de l'hitorique";
$LANG['plugin_backups']['setup'][9] = "Type de sauvegarde";

$LANG['plugin_backups']['parser'][0] = "Fichiers";
$LANG['plugin_backups']['parser'][1] = "Lire le journal";
$LANG['plugin_backups']['parser'][2] = "Impossible de trouver le fichier XML";
$LANG['plugin_backups']['parser'][3] = "Aucun fichier trouvé dans le répertoire";
$LANG['plugin_backups']['parser'][4] = "Journal";
