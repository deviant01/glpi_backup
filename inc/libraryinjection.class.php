...
class PluginBackupsLibraryInjection extends PluginBackupsLibrary
   implements PluginDatainjectionInjectionInterface {

   function __construct() {
      //Needed for getSearchOptions !
      $this->table = getTableForItemType('PluginBackupsLibrary');
   }
   ...
   function getOptions($primary_type = '') {
      ...
      $options['displaytype'] = array("multiline_text" => array(5));
