...
class PluginBackupsScriptInjection extends PluginBackupsScript
   implements PluginDatainjectionInjectionInterface {

   function __construct() {
      //Needed for getSearchOptions !
      $this->table = getTableForItemType('PluginBackupsScript');
   }
   ...
   function getOptions($primary_type = '') {
      ...
      $options['displaytype'] = array("dropdown" => array(2),
