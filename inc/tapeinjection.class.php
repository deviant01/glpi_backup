...
class PluginBackupsTapeInjection extends PluginBackupsTape
   implements PluginDatainjectionInjectionInterface {

   function __construct() {
      //Needed for getSearchOptions !
      $this->table = getTableForItemType('PluginBackupsTape');
   }
   ...
   function getOptions($primary_type = '') {
      ...
      $options['displaytype'] = array("dropdown"       => array(2,7),
                                      "user"           => array(11),
                                      "multiline_text" => array(5),
                                      "date"           => array(6));
