...
if ($plugin->isActivated("environment"))
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER['PHP_SELF'],"plugins","environment","libraries");
else
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER["PHP_SELF"],"plugins","backups","libraries");

$lib = new PluginBackupsLibrary();

if ($lib->canView() || Session::haveRight("config","w")) {

   Search::show("PluginBackupsLibrary");
