...
if ($plugin->isActivated("environment"))
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER['PHP_SELF'],"plugins","environment","tapes");
else
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER["PHP_SELF"],"plugins","backups","tapes");

$tape = new PluginBackupsTape();

if ($tape->canView() || Session::haveRight("config","w")) {

   Search::show("PluginBackupsTape");
