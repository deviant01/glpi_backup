...
if ($plugin->isActivated("environment"))
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER['PHP_SELF'],"plugins","environment","works");
else
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER["PHP_SELF"],"plugins","backups","works");

$work = new PluginBackupsWork();

if ($work->canView() || Session::haveRight("config","w")) {

   Search::show("PluginBackupsWork");
