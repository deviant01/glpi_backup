...
if ($plugin->isActivated("environment"))
   Html::header($LANG['plugin_backups']['title'][1],$_SERVER['PHP_SELF'],"plugins","environment","works");
else
   Html::header($LANG['plugin_backups']['title'][1],$_SERVER["PHP_SELF"],"plugins","backups","works");

$work = new PluginBackupsWork();

if ($work->canView() || Session::haveRight("config","w")) {
   
   $work->listOfTemplates($CFG_GLPI["root_doc"]."/plugins/backups/front/work.form.php",$_GET["add"]);
