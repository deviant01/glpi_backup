...
else
{
   ...
   if ($plugin->isActivated("environment"))
      Html::header($LANG['plugin_backups']['title'][0],'',"plugins","environment","history");
   else
      Html::header($LANG['plugin_backups']['title'][0],'',"plugins","backups","history");

   $log->showForm($_GET["id"]);
