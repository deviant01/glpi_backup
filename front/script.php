...
if ($plugin->isActivated("environment"))
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER['PHP_SELF'],"plugins","environment","scripts");
else
   Html::header($LANG['plugin_backups']['title'][0],$_SERVER["PHP_SELF"],"plugins","backups","scripts");

$script = new PluginBackupsScript();

if ($script->canView() || Session::haveRight("config","w")) {

   Search::show("PluginBackupsScript");
